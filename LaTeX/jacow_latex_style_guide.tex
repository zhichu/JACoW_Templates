...
\title{\NoCaseChange{JACoW} {\LaTeX} Style Guide (\NoCaseChange{v}.2026-02-23)%
...
\begin{figure*}[!ht]
    \centering
    \includegraphics*[width=\textwidth]{jacow_groupphoto_tm2025}
...
and math-mode, the second one is in text mode, but requires special attention width)
...
%\begin{thebibliography}{9} % Use for 1-9 references
	...
	\bibitem{IUPAC-Green}
		...
		Royal Society of Chemistry. 120 pages, Nov. 2023. Printed book version or digital access behind paywall:
		\doi{10.1039/9781839163180}

	\bibitem{IUPAC-Green-Abr}
		Green Book, Quantities, Units and Symbols in Physical Chemistry: 4th Edition, Abridged Version,
		Royal Society of Chemistry, 120 pages (downloadable), 2023.
